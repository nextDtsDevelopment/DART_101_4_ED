void main() {
  ...
  print(mensaje2
      .split("")); // ["H", "o", "l", "a"] // Regex -> Expresiones Regulares

  print("${mensaje2}"
      .trim()); // " Hola Mundo " -> "Hola Mundo" -> " test@test.com " -> hagamos la operación y borrar los espacios -> formularios
  ...
  print("Ejemplo");
  print(varibale9 +=
      10); // varibale9 = varibale9 + 10; // 11 // Operadores de asignación
